...
import torch
from fms.models import __models as _fms_models
...
class InferenceEngine(BaseInferenceEngine):
    def __init__(
        ...
        if variant_match is None:
            raise ValueError(
                f"Unable to determine model variant from model: {model_path}",
            )
    ...
    @classmethod
    def _find_variant(cls, model_config_dict: dict, fms_architecture) -> str | None:
