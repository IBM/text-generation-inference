...
def get_ptb(nsamples, seed, seqlen, model_name):
    from datasets import load_dataset
...
def get_c4(nsamples, seed, seqlen, model_name):
    from datasets import load_dataset
...
def get_ptb_new(nsamples, seed, seqlen, model_name):
    from datasets import load_dataset
...
def get_c4_new(nsamples, seed, seqlen, model_name):
    from datasets import load_dataset
...
def get_loaders(name, nsamples=128, seed=0, seqlen=2048, model_name=""):
